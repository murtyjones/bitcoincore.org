...
Bitcoin already suffers from some significant design debt, and segwit is specifically designed to reduce the impact of some of this debt (notably transaction malleability, exponential scaling of signature hashing, and signing of input values).
